        ...
        for k, v in self.graph.items():
            for n in v:
                if n[0].properties.zone in ['normal', 'priority']:
                    time = 1
                if n[0].properties.zone == 'restricted':
                    time = 2
                if n[0].properties.zone == 'blocked':
                    time = 0
